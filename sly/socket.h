 ...
 */
    ...
    public:
        ...
        /**
         * @brief 发送数据 这个函数用于发送多个数据缓冲区，每个缓冲区可以有不同的大小
        ...
        /**
         * @brief 发送数据 这个函数用于向指定的目标地址发送一个连续的数据缓冲区。
         * @param[in] buffer 待发送数据的内存
         * @param[in] length 待发送数据的长度
         * @param[in] to 发送的目标地址
         * @param[in] flags 标志字
        ...
        /**
         * @brief 发送数据 这个函数用于向指定的目标地址发送多个数据缓冲区，每个缓冲区可以有不同的大小。
         * @param[in] buffers 待发送数据的内存(iovec数组)
         * @param[in] length 待发送数据的长度(iovec长度)
         * @param[in] to 发送的目标地址
         * @param[in] flags 标志字
